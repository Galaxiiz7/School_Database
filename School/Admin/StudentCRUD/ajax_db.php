<?php
          ...
          $con= mysqli_connect("localhost","root","","school_db") or die("Error: " . mysqli_error($con));
  ...
  if (isset($_POST['function']) && $_POST['function'] == 'provinces') {
  	...
  	echo '<option value="" selected disabled>-Please Select Amphures-</option>';
...
if (isset($_POST['function']) && $_POST['function'] == 'amphures') {
    ...
    $query = mysqli_query($con, $sql);
    echo '<option value="" selected disabled>-Please Select District-</option>';
