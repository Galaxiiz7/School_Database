...
--
-- Host: 127.0.0.1
-- Generation Time: May 29, 2023 at 08:39 AM
...
INSERT INTO `books` (`book_id`, `book_name`, `author`, `book_price`) VALUES
(101, 'Perfect English ', 'Nannapin Patcharapre', 220),
(102, 'English From Zero', 'Fonkaew Jittaworawet', 250),
(201, 'THE ODD BODY ', 'Theepob Srisadudee ', 360),
(202, 'Parallel Worlds', 'Rat Komsakul', 297),
(301, 'Easy Note Math', 'Pawanya Pongpanitch ', 185),
(302, 'THE TOP MATHEMATICS ', 'Thantat Udomdechraks', 330),
(401, 'Love Health', 'Korapol Kiatsakul ', 280),
(402, 'Physical Education', 'Ratima Rattanapraser', 177),
(501, 'Art & Craft', 'Kanjanaporn Tontong ', 223),
(502, 'Throwback', 'Chachaya Tanajaroenk', 189),
(601, 'Social Studies ', 'Paporn Jantarapipat', 300),
(602, 'The Social Studies', 'Thawan Pongpilai', 176),
(701, 'The Social Network ', 'Pakapong Mankongpras', 150),
(702, 'Artificial Intellige', 'Pacharawat Kaewmala', 247),
(999, 'Database', 'Dech', 600),
(1001, 'THAIEAZY', 'Amporn Siripachasab ', 150),
(1002, 'THAIHARD', 'Amporn Siripachasab ', 180);
...
INSERT INTO `book_subjects` (`book_id`, `subject_id`, `school_year`, `semester`) VALUES
(101, 'ENG101', 2021, 1),
(102, 'ENG101', 2021, 1),
(201, 'SCI101', 2021, 1),
(202, 'SCI10301', 2021, 1),
...
INSERT INTO `classrooms` (`classroom`, `curriculum_id`) VALUES
('4/1', 'SM1'),
('4/2', 'SM2'),
('4/3', 'AM1'),
('4/4', 'AM2'),
...
INSERT INTO `classroom_subjects` (`classroom`, `school_year`, `semester`, `subject_id`) VALUES
('4/1', 2021, 1, 'ART001'),
('4/1', 2021, 1, 'COM001'),
('4/1', 2021, 1, 'MTH101'),
('4/1', 2021, 1, 'SCI101'),
...
INSERT INTO `curriculums` (`curriculum_id`, `curriculum_name`) VALUES
('AL1', 'Arts-Language-Chinese'),
('AL2', 'Arts-Language-Japanese'),
('MA1', 'Arts-Mathematics'),
('MA2', 'Arts-Mathematics-Inter'),
('SM1', 'Science-Mathematics'),
('SM2', 'Science-Mathematics-Inter');

-- --------------------------------------------------------

--
-- Table structure for table `curriculum_prices`
--

CREATE TABLE `curriculum_prices` (
  `curriculum_id` varchar(5) NOT NULL,
  `school_year` year(4) NOT NULL,
  `curriculum_price` float NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `curriculum_prices`
--

INSERT INTO `curriculum_prices` (`curriculum_id`, `school_year`, `curriculum_price`) VALUES
('AL1', 2021, 20000),
('AL1', 2022, 21000),
('AL1', 2023, 22000),
('AL2', 2021, 21000),
...
CREATE TABLE `students` (
  ...
  `student_telnumber` varchar(10) NOT NULL,
  `student_email` varchar(50) NOT NULL,
  `student_address` varchar(50) NOT NULL,
  `student_province` int(10) NOT NULL,
  `student_amphur` int(10) NOT NULL,
  `student_district` int(10) NOT NULL,
  `student_zipcode` int(10) NOT NULL,
  `student_since` date NOT NULL,
  `student_status` varchar(10) DEFAULT NULL,
  `student_curriculum_id` varchar(5) NOT NULL,
...
INSERT INTO `students` (`student_id`, `student_fname`, `student_lname`, `student_gender`, `student_birthdate`, `student_telnumber`, `student_email`, `student_address`, `student_province`, `student_amphur`, `student_district`, `student_zipcode`, `student_since`, `student_status`, `student_curriculum_id`, `password`) VALUES
(999, 'DECC', 'DA', 'Male', '2023-05-02', '085022', 'earth@ggg', '123', 3, 58, 120102, 11000, '2023-05-01', 'Student', 'AL2', '999'),
(10001, 'Chanawan ', 'Tarangam ', 'Female', '2005-02-08', '0922675931', 'a@gmail.com', '333 Westchester Avenue Suite 101 West', 2, 54, 110303, 10540, '2021-05-05', 'Student', 'AL2', '10001'),
(10002, 'Jantarat ', 'Pongpilai ', 'Female', '2005-12-07', '0922675932', 'b@gmail.com', '2501 W 84th St', 2, 56, 110502, 10290, '2021-05-05', 'Student', 'AL1', '10002'),
(10003, 'Pawadee ', 'Phupak ', 'Female', '2005-02-12', '0922675933', 'c@gmail.com', '905 Lakeside Dr., Suite A', 1, 10, 101001, 10510, '2021-05-05', 'Student', 'AL2', '10003'),
(10004, 'Korn ', 'Tanachokwanich ', 'Male', '2005-06-05', '0922675934', 'd@gmail.com', '139 North 5th Street', 1, 11, 101101, 10520, '2021-05-05', 'Student', 'AL1', '10004'),
(10005, 'Pitipong ', 'Achachai ', 'Male', '2005-05-08', '0922675935', 'e@gmail.com', '3195 McMillan Ste F', 1, 13, 101301, 10100, '2021-05-05', 'Student', 'MA2', '10005'),
(10006, 'Chanai ', 'Jaroenpolwattana ', 'Male', '2005-05-05', '0922675936', 'f@gmail.com', '1830 Airport Road', 1, 43, 104301, 10230, '2021-05-05', 'Student', 'MA2', '10006'),
(10007, 'Pongsakorn ', 'Nantapoj ', 'Male', '2005-09-04', '0922675937', 'g@gmail.com', '5241 N Maple Ave', 1, 8, 100804, 10100, '2021-05-05', 'Student', 'MA1', '10007'),
(10008, 'Jirachoti ', 'Rattanaatid ', 'Male', '2005-02-04', '0922675938', 'h@gmail.com', '800 N State College Blvd', 2, 55, 110410, 10130, '2021-05-05', 'Student', 'MA1', '10008'),
(10009, 'Thawin ', 'Treesup ', 'Male', '2005-12-25', '0922675939', 'i@gmail.com', '1250 Bellflower Blvd', 1, 15, 101503, 10600, '2021-05-05', 'Student', 'SM1', '10009'),
(10010, 'Kansika ', 'Sisaard ', 'Female', '2005-02-12', '0922675941', 'k@gmail.com', '100 Campus Center', 2, 53, 110202, 10560, '2021-05-05', 'Student', 'SM1', '10010'),
(10011, 'Tanin ', 'Tanakiatkosol ', 'Male', '2005-12-24', '0922675942', 'j@gmail.com', '18111 Nordhoff St', 1, 15, 101503, 10600, '2021-05-05', 'Student', 'SM2', '10011'),
(10012, 'Weerakiat ', 'Siriwanich ', 'Male', '2005-12-14', '0922675943', 'l@gmail.com', '6000 J St', 2, 54, 110308, 10540, '2021-05-05', 'Student', 'SM2', '10012'),
(10013, 'Sasima ', 'Chotawanich ', 'Female', '2006-02-06', '0922675944', 'm@gmail.com', '4300 Sisk Rd', 1, 15, 101501, 10600, '2022-05-05', 'Student', 'AL2', '10013'),
(10014, 'Kitti ', 'Sirikoson ', 'Male', '2006-02-06', '0922675945', 'n@gmail.com', '202 East University Street, suite H, I,& J', 4, 67, 130203, 12120, '2022-05-05', 'Student', 'AL2', '10014'),
(10015, 'Kanokwan', 'Pichitcharoenwong ', 'Female', '2006-12-30', '0922675946', 'o@gmail.com', '2500 Georgetown Rd', 7, 100, 160412, 15130, '2022-05-05', 'Student', 'AL1', '10015'),
(10016, 'Pakapong ', 'Weerapakmethee', 'Female', '2006-11-25', '0922675947', 'p@gmail.com', '37174 State Hwy V V', 14, 173, 230302, 23150, '2022-05-05', 'Student', 'AL1', '10016'),
(10017, 'Chidchanok ', 'Krajangjit ', 'Female', '2006-10-27', '0922675948', 'q@gmail.com', '1000 Vermillion Street', 5, 76, 140302, 13260, '2022-05-05', 'Student', 'MA2', '10017'),
(10018, 'Nataporn ', 'Pleumpiti ', 'Female', '2006-10-24', '0922675949', 'r@gmail.com', '111 N. Havana Street', 1, 12, 101204, 10120, '2022-05-05', 'Student', 'MA2', '10018'),
(10019, 'Thammanit ', 'Srisoi ', 'Male', '2006-04-07', '0922675950', 's@gmail.com', '130 Essex St', 1, 18, 101802, 10600, '2022-05-05', 'Student', 'MA1', '10019'),
(10020, 'Chawit ', 'Udomdechraksa', 'Male', '2006-12-05', '0922675951', 't@gmail.com', '1700 S Main St', 4, 67, 130204, 12120, '2022-12-15', 'Student', 'MA1', '10020'),
(10021, 'Petcharat ', 'Tanomjit ', 'Male', '2006-04-05', '0922675952', 'u@gmail.com', '1021 Dulaney Valley Rd', 4, 69, 130403, 12170, '2022-05-05', 'Student', 'SM2', '10021'),
(10022, 'Chayon ', 'Worawongkunakorn ', 'Male', '2006-05-15', '0922675953', 'v@gmail.com', '1 University Pky', 3, 59, 120202, 11130, '2022-05-05', 'Student', 'SM2', '10022'),
(10023, 'Thanased', 'Suwansiri ', 'Male', '2006-05-23', '0922675954', 'w@gmail.com', '9833 Watson Road', 1, 14, 101401, 10400, '2022-05-05', 'Student', 'SM1', '10023'),
(10024, 'Kraisorn ', 'Jantarasab ', 'Male', '2006-05-05', '0922675955', 'h@gmail.com', '1011 Aldon SW', 2, 52, 110103, 10270, '2022-05-05', 'Student', 'SM1', '10024'),
(10025, 'Darunai ', 'Sirilai ', 'Male', '2007-10-04', '0922675956', 'aa@gmail.com', '1519 Clearlake Rd', 5, 75, 140202, 13130, '2023-05-05', 'Student', 'AL2', '10025');
...
CREATE TABLE `student_classrooms` (
  `student_id` int(10) NOT NULL,
  `school_year` year(4) NOT NULL,
  `student_classroom` varchar(5) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `student_classrooms` (`student_id`, `school_year`, `student_classroom`) VALUES
(10009, 2021, '4/1'),
(10010, 2021, '4/1'),
(10023, 2022, '4/1'),
(10024, 2022, '4/1'),
...
INSERT INTO `student_payments` (`student_id`, `school_year`, `semester`, `paid`, `timestamp`) VALUES
(10001, 2021, 1, 0, '2023-05-29 13:28:56.000000'),
(10001, 2021, 2, 1, '2023-05-29 02:30:54.000000'),
(10001, 2022, 1, 1, '2023-05-29 02:31:08.000000'),
(10001, 2022, 2, 1, '2023-05-29 02:31:21.000000'),
(10001, 2023, 1, 1, '2023-05-29 02:31:44.000000'),
(10001, 2023, 2, 1, '2023-05-29 02:31:50.000000'),
(10002, 2021, 1, 1, '2023-05-29 02:33:44.000000'),
(10002, 2021, 2, 1, '2023-05-29 02:33:55.000000'),
(10002, 2022, 1, 1, '2023-05-29 02:34:07.000000'),
(10002, 2022, 2, 1, '2023-05-29 02:34:14.000000'),
(10002, 2023, 1, 1, '2023-05-29 02:34:27.000000'),
(10002, 2023, 2, 1, '2023-05-29 02:34:40.000000'),
(10003, 2021, 1, 1, '2023-05-29 02:35:22.000000'),
(10003, 2021, 2, 1, '2023-05-29 02:35:31.000000'),
(10003, 2022, 1, 1, '2023-05-29 02:35:38.000000'),
(10003, 2022, 2, 1, '2023-05-29 02:35:44.000000'),
(10003, 2023, 1, 1, '2023-05-29 02:35:51.000000'),
(10003, 2023, 2, 1, '2023-05-29 02:35:58.000000'),
(10004, 2021, 1, 1, '2023-05-29 02:36:09.000000'),
(10004, 2021, 2, 0, '2023-05-29 02:36:18.000000'),
(10004, 2022, 1, 0, '2023-05-29 02:36:54.000000'),
(10004, 2022, 2, 0, '2023-05-29 02:37:05.000000'),
(10004, 2023, 1, 0, '2023-05-29 02:37:10.000000'),
(10004, 2023, 2, 0, '2023-05-29 02:37:16.000000'),
(10005, 2021, 1, 1, '2023-05-29 02:37:23.000000'),
(10005, 2021, 2, 1, '2023-05-29 02:37:28.000000'),
(10005, 2022, 1, 0, '2023-05-29 02:36:26.000000'),
(10005, 2022, 2, 0, '2023-05-29 02:36:38.000000'),
(10005, 2023, 1, 0, '2023-05-29 02:38:37.000000'),
(10005, 2023, 2, 0, '2023-05-29 02:38:42.000000'),
(10006, 2021, 1, 1, '2023-05-29 02:38:52.000000'),
(10006, 2021, 2, 1, '2023-05-29 02:38:59.000000'),
(10006, 2022, 1, 1, '2023-05-29 02:39:05.000000'),
(10006, 2022, 2, 1, '2023-05-29 02:39:13.000000'),
(10006, 2023, 1, 1, '2023-05-29 02:39:25.000000'),
(10006, 2023, 2, 1, '2023-05-29 02:40:03.000000'),
(10007, 2021, 1, 1, '2023-05-29 02:40:10.000000'),
(10007, 2021, 2, 1, '2023-05-29 02:40:22.000000'),
(10007, 2022, 1, 1, '2023-05-29 02:40:28.000000'),
(10007, 2022, 2, 1, '2023-05-29 02:40:34.000000'),
(10007, 2023, 1, 0, '2023-05-29 02:40:49.000000'),
(10007, 2023, 2, 0, '2023-05-29 02:40:44.000000'),
(10008, 2021, 1, 0, '2023-05-29 02:40:58.000000'),
(10008, 2021, 2, 0, '2023-05-29 02:41:04.000000'),
(10008, 2022, 1, 1, '2023-05-29 02:41:12.000000'),
(10008, 2022, 2, 1, '2023-05-29 02:41:19.000000'),
(10008, 2023, 1, 1, '2023-05-29 02:41:26.000000'),
(10008, 2023, 2, 1, '2023-05-29 02:41:34.000000'),
(10009, 2021, 1, 1, '2023-05-29 10:57:24.000000'),
(10009, 2021, 2, 1, '2023-05-29 10:57:54.000000'),
(10009, 2022, 1, 1, '2023-05-29 10:58:13.000000'),
(10009, 2022, 2, 1, '2023-05-29 10:58:23.000000'),
(10009, 2023, 1, 1, '2023-05-29 10:58:37.000000'),
(10009, 2023, 2, 0, '2023-05-29 10:58:50.000000'),
(10010, 2021, 1, 1, '2023-05-29 10:59:54.000000'),
(10010, 2021, 2, 1, '2023-05-29 11:00:06.000000'),
(10010, 2022, 1, 0, '2023-05-29 11:00:16.000000'),
(10010, 2022, 2, 1, '2023-05-29 11:00:32.000000'),
(10010, 2023, 1, 1, '2023-05-29 11:00:54.000000'),
(10010, 2023, 2, 0, '2023-05-29 11:01:03.000000'),
(10011, 2021, 1, 1, '2023-05-29 11:01:29.000000'),
(10011, 2021, 2, 0, '2023-05-29 11:01:40.000000'),
(10011, 2022, 1, 1, '2023-05-29 11:01:50.000000'),
(10011, 2022, 2, 1, '2023-05-29 11:02:04.000000'),
(10011, 2023, 1, 1, '2023-05-29 11:02:15.000000'),
(10011, 2023, 2, 1, '2023-05-29 11:02:23.000000'),
(10012, 2021, 1, 1, '2023-05-29 11:02:46.000000'),
(10012, 2021, 2, 1, '2023-05-29 11:02:56.000000'),
(10012, 2022, 1, 1, '2023-05-29 11:03:11.000000'),
(10012, 2022, 2, 1, '2023-05-29 11:03:23.000000'),
(10012, 2023, 1, 1, '2023-05-29 11:03:35.000000'),
(10012, 2023, 2, 1, '2023-05-29 11:03:44.000000'),
(10013, 2022, 1, 0, '2023-05-29 11:05:09.000000'),
(10013, 2022, 2, 1, '2023-05-29 11:05:17.000000'),
(10013, 2023, 1, 1, '2023-05-29 11:07:57.000000'),
(10013, 2023, 2, 0, '2023-05-29 11:08:08.000000'),
(10014, 2022, 1, 1, '2023-05-29 11:08:30.000000'),
(10014, 2022, 2, 1, '2023-05-29 11:09:01.000000'),
(10014, 2023, 1, 1, '2023-05-29 11:09:12.000000'),
(10014, 2023, 2, 1, '2023-05-29 11:09:19.000000'),
(10015, 2022, 1, 1, '2023-05-29 11:09:49.000000'),
(10015, 2022, 2, 1, '2023-05-29 11:10:00.000000'),
(10015, 2023, 1, 1, '2023-05-29 11:10:09.000000'),
(10015, 2023, 2, 0, '2023-05-29 11:10:20.000000'),
(10016, 2022, 1, 1, '2023-05-29 11:10:38.000000'),
(10016, 2022, 2, 1, '2023-05-29 11:10:46.000000'),
(10016, 2023, 1, 1, '2023-05-29 11:10:53.000000'),
(10016, 2023, 2, 1, '2023-05-29 11:11:00.000000'),
(10017, 2022, 1, 1, '2023-05-29 11:11:19.000000'),
(10017, 2022, 2, 1, '2023-05-29 11:11:27.000000'),
(10017, 2023, 1, 1, '2023-05-29 11:11:35.000000'),
(10017, 2023, 2, 0, '2023-05-29 11:11:44.000000'),
(10018, 2022, 1, 1, '2023-05-29 11:12:03.000000'),
(10018, 2022, 2, 1, '2023-05-29 11:12:09.000000'),
(10018, 2023, 1, 1, '2023-05-29 11:12:17.000000'),
(10018, 2023, 2, 1, '2023-05-29 11:12:26.000000'),
(10019, 2022, 1, 1, '2023-05-29 11:12:44.000000'),
(10019, 2022, 2, 1, '2023-05-29 11:12:50.000000'),
(10019, 2023, 1, 1, '2023-05-29 11:12:58.000000'),
(10019, 2023, 2, 1, '2023-05-29 11:13:06.000000'),
(10020, 2022, 1, 1, '2023-05-29 11:13:25.000000'),
(10020, 2022, 2, 0, '2023-05-29 11:13:33.000000'),
(10020, 2023, 1, 1, '2023-05-29 11:13:40.000000'),
(10020, 2023, 2, 1, '2023-05-29 11:13:49.000000'),
(10021, 2022, 1, 1, '2023-05-29 11:14:46.000000'),
(10021, 2022, 2, 1, '2023-05-29 11:14:58.000000'),
(10021, 2023, 1, 1, '2023-05-29 11:15:07.000000'),
(10021, 2023, 2, 1, '2023-05-29 11:15:19.000000'),
(10022, 2022, 1, 1, '2023-05-29 11:15:51.000000'),
(10022, 2022, 2, 1, '2023-05-29 11:16:07.000000'),
(10022, 2023, 1, 1, '2023-05-29 11:16:18.000000'),
(10022, 2023, 2, 1, '2023-05-29 11:16:34.000000'),
(10023, 2022, 1, 1, '2023-05-29 11:16:54.000000'),
(10023, 2022, 2, 1, '2023-05-29 11:17:01.000000'),
(10023, 2023, 1, 0, '2023-05-29 11:17:10.000000'),
(10023, 2023, 2, 0, '2023-05-29 11:17:19.000000'),
(10024, 2022, 1, 1, '2023-05-29 11:17:30.000000'),
(10024, 2022, 2, 1, '2023-05-29 11:17:39.000000'),
(10024, 2023, 1, 1, '2023-05-29 11:17:48.000000'),
(10024, 2023, 2, 1, '2023-05-29 11:18:01.000000'),
(10025, 2023, 1, 1, '2023-05-29 11:18:14.000000'),
(10025, 2023, 2, 0, '2023-05-29 11:18:23.000000');
...
INSERT INTO `student_subjects` (`student_id`, `subject_id`, `school_year`, `semester`, `score`) VALUES
(10001, 'ART001', 2021, 1, NULL),
(10001, 'ART001', 2023, 1, 85),
(10001, 'COM002', 2021, 1, 90),
(10001, 'HPE001', 2021, 2, 55),
(10001, 'HPE002', 2022, 1, 53),
(10001, 'MTH102', 2021, 1, 88),
(10001, 'SCI101', 2021, 1, NULL),
(10001, 'SOC002', 2022, 1, NULL),
(10001, 'THA001', 2021, 1, NULL),
(10002, 'ART001', 2021, 1, NULL),
(10002, 'ART001', 2023, 1, NULL),
(10002, 'COM002', 2021, 1, NULL),
(10002, 'ENG101', 2021, 1, NULL),
(10002, 'HPE001', 2021, 2, NULL),
(10002, 'HPE002', 2022, 1, NULL),
(10002, 'MTH102', 2021, 1, NULL),
(10002, 'SCI101', 2021, 1, NULL),
(10002, 'SOC002', 2022, 1, NULL),
(10002, 'THA001', 2021, 1, NULL),
(10003, 'ART001', 2021, 1, NULL),
(10003, 'ART001', 2023, 1, NULL),
(10003, 'COM002', 2021, 1, NULL),
(10003, 'HPE001', 2021, 2, NULL),
(10003, 'HPE002', 2022, 1, NULL),
(10003, 'MTH102', 2021, 1, NULL),
(10003, 'SCI101', 2021, 1, NULL),
(10003, 'SOC002', 2022, 1, NULL),
(10003, 'THA001', 2021, 1, NULL),
(10004, 'ART001', 2021, 1, NULL),
(10004, 'ART001', 2023, 1, NULL),
(10004, 'COM002', 2021, 1, NULL),
(10004, 'ENG101', 2021, 1, NULL),
(10004, 'HPE001', 2021, 2, NULL),
(10004, 'HPE002', 2022, 1, NULL),
(10004, 'MTH102', 2021, 1, NULL),
(10004, 'SCI101', 2021, 1, NULL),
(10004, 'SOC002', 2022, 1, NULL),
(10004, 'THA001', 2021, 1, NULL),
(10005, 'ART001', 2021, 1, NULL),
(10005, 'ENG101', 2021, 1, NULL),
(10005, 'HPE001', 2021, 2, NULL),
(10005, 'HPE002', 2022, 1, NULL),
(10005, 'SCI101', 2021, 1, NULL),
(10005, 'SOC002', 2022, 1, NULL),
(10005, 'THA001', 2021, 1, NULL),
(10006, 'ART001', 2021, 1, NULL),
(10006, 'ENG101', 2021, 1, NULL),
(10006, 'HPE001', 2021, 2, NULL),
(10006, 'HPE002', 2022, 1, NULL),
(10006, 'SCI101', 2021, 1, NULL),
(10006, 'SOC002', 2022, 1, NULL),
(10006, 'THA001', 2021, 1, NULL),
(10007, 'ART001', 2021, 1, NULL),
(10007, 'ART002', 2023, 2, NULL),
(10007, 'HPE001', 2021, 2, NULL),
(10007, 'HPE002', 2022, 1, NULL),
(10007, 'SCI101', 2021, 1, NULL),
(10007, 'SCI10301', 2021, 1, NULL),
(10007, 'SOC001', 2022, 1, NULL),
(10007, 'THA001', 2021, 1, NULL),
(10008, 'ART001', 2021, 1, NULL),
(10008, 'ART002', 2023, 2, NULL),
(10008, 'HPE001', 2021, 2, NULL),
(10008, 'HPE002', 2022, 1, NULL),
(10008, 'SCI101', 2021, 1, NULL),
(10008, 'SCI10301', 2021, 1, NULL),
(10008, 'SOC001', 2022, 1, NULL),
(10008, 'THA001', 2021, 1, NULL),
(10009, 'ART001', 2021, 1, NULL),
(10009, 'ART002', 2023, 2, NULL),
(10009, 'COM001', 2021, 1, 20),
(10009, 'ENG102', 2021, 2, NULL),
(10009, 'ENG103', 2021, 2, NULL),
(10009, 'HPE001', 2021, 2, NULL),
(10009, 'HPE002', 2022, 1, NULL),
(10009, 'MTH101', 2021, 1, NULL),
(10009, 'SCI101', 2021, 1, NULL),
(10009, 'SCI10301', 2021, 1, NULL),
(10009, 'SOC001', 2021, 1, NULL),
(10009, 'SOC001', 2022, 1, NULL),
(10009, 'THA001', 2021, 1, NULL),
(10010, 'ART001', 2021, 1, NULL),
(10010, 'ART002', 2023, 2, NULL),
(10010, 'COM001', 2021, 1, NULL),
(10010, 'HPE001', 2021, 2, NULL),
(10010, 'HPE002', 2022, 1, NULL),
(10010, 'SOC001', 2021, 1, NULL),
(10010, 'SOC001', 2022, 1, NULL),
(10010, 'THA001', 2021, 1, NULL),
(10011, 'ART001', 2021, 1, NULL),
(10011, 'ART002', 2023, 2, NULL),
(10011, 'COM001', 2021, 1, NULL),
(10011, 'HPE001', 2021, 2, NULL),
(10011, 'HPE002', 2022, 1, NULL),
(10011, 'SOC001', 2021, 1, NULL),
(10011, 'SOC001', 2022, 1, NULL),
(10011, 'THA001', 2021, 1, NULL),
(10012, 'ART001', 2021, 1, NULL),
(10012, 'ART002', 2023, 2, NULL),
(10012, 'COM001', 2021, 1, NULL),
(10012, 'HPE001', 2021, 2, NULL),
(10012, 'HPE002', 2022, 1, NULL),
(10012, 'SOC001', 2021, 1, NULL),
(10012, 'SOC001', 2022, 1, NULL),
(10012, 'THA001', 2021, 1, NULL);
...
CREATE TABLE `subjects` (
  ...
  `learning_group` varchar(50) NOT NULL,
...
INSERT INTO `subjects` (`subject_id`, `school_year`, `semester`, `subject_name`, `learning_group`, `credit`) VALUES
('ART001', 2021, 1, 'Art', 'Arts Department', 0.5),
('ART001', 2023, 1, 'Art', 'Arts Department', 0.5),
('ART002', 2023, 2, 'Art', 'Arts Department', 0.5),
('COM001', 2021, 1, 'Computer', 'Career and Technology Department', 2),
('COM002', 2021, 1, 'Computer', 'Career and Technology Department', 2),
('ENG101', 2021, 1, 'English', 'Foreign Languages Department', 1),
('ENG102', 2021, 2, 'EnglishEE', 'Foreign Languages Department', 1.5),
('ENG103', 2021, 2, 'EnglishEE', 'Foreign Languages Department', 1.5),
('HPE001', 2021, 2, 'Physical Education', 'Health and Physical Education Department', 0.5),
('HPE002', 2022, 1, 'Physical Education', 'Health and Physical Education Department', 0.5),
('MTH101', 2021, 1, 'Math', 'Mathematics Department', 1.5),
('MTH102', 2021, 1, 'Math', 'Mathematics Department', 1.5),
('SCI101', 2021, 1, 'Science101', 'Science Department', 1.5),
('SCI10301', 2021, 1, 'Science10301', 'Science Department', 1.5),
('SOC001', 2021, 1, 'Social Study', 'Social studies, Religion and Culture Department', 1.5),
('SOC001', 2022, 1, 'Social Study', 'Social studies, Religion and Culture Department', 1.5),
('SOC002', 2022, 1, 'Social Study', 'Social studies, Religion and Culture Department', 1.5),
('THA001', 2021, 1, 'Thai Language', 'Thai Language Department', 1),
('THA002', 2021, 1, 'Thai Language', 'Thai Language Department', 2);
...
CREATE TABLE `teachers` (
  ...
  `teacher_telnumber` varchar(10) NOT NULL,
  `teacher_email` varchar(50) NOT NULL,
  `teacher_address` varchar(50) NOT NULL,
  `teacher_province` int(10) NOT NULL,
  `teacher_amphur` int(10) NOT NULL,
  `teacher_district` int(10) NOT NULL,
  `teacher_zipcode` int(10) NOT NULL,
  `teacher_since` date NOT NULL,
  `teacher_learning_group` varchar(50) NOT NULL,
...
INSERT INTO `teachers` (`teacher_id`, `teacher_fname`, `teacher_lname`, `teacher_gender`, `teacher_birthdate`, `teacher_telnumber`, `teacher_email`, `teacher_address`, `teacher_province`, `teacher_amphur`, `teacher_district`, `teacher_zipcode`, `teacher_since`, `teacher_learning_group`, `teacher_position`, `teacher_salary`) VALUES
(999, 'Dech', 'Nalu', 'Male', '2023-05-02', '0323232323', 'EqaeDA@adad', '13/7', 16, 196, 250806, 25140, '2023-05-04', 'Social studies, Religion and Culture Department', 'POS', 10000),
(1001, 'Shaine', 'Corradetti', 'Female', '1994-05-02', '0813427575', 'Shaine@mail.com', '177/34', 1, 3, 100303, 10530, '2023-05-28', 'Thai Language Department', 'Teacher', 20000),
(1002, 'Jojo', 'Chidzoy', 'Female', '2000-05-08', '0816714412', 'Jojo@mail.com', '174/66', 11, 144, 200901, 20180, '2023-05-28', 'Thai Language Department', 'Teacher', 21000),
(1003, 'Edie', 'Conningham', 'Male', '2000-05-25', '0826878844', 'Edie@mail.com', '112/1', 11, 143, 200801, 20120, '2023-05-18', 'Thai Language Department', 'Teacher', 20000),
(1101, 'Tish', 'Keyho', 'Female', '2000-01-17', '0956837745', 'Tish@mail.com', '145/66', 2, 52, 110108, 10280, '2023-05-01', 'Foreign Languages Department', 'Teacher', 23000),
(1102, 'Thaxter', 'Tanswill', 'Male', '2000-05-02', '0941747758', 'Thaxter@mail.com', '14/67', 6, 91, 150206, 14140, '2023-01-24', 'Foreign Languages Department', 'Teacher', 25000),
(1103, 'Langston', 'Allchin', 'Male', '1988-10-12', '0844457768', 'Langston@mail.com', '11/8', 3, 59, 120205, 11130, '2020-11-02', 'Foreign Languages Department', 'Teacher', 26000),
(1201, 'Blair', 'Manger', 'Male', '1975-07-04', '0943778456', 'Blair@mail.com', '19/5', 5, 83, 141003, 13230, '2000-12-05', 'Science Department', 'Teacher', 30000),
(1202, 'Maritsa', 'Steward', 'Female', '2000-12-28', '0847751234', 'Maritsa@mail.com', '17/66', 1, 9, 100905, 10260, '2023-05-28', 'Science Department', 'Teacher', 15000),
(1203, 'Milty', 'Delete', 'Female', '1997-01-24', '0846672534', 'Milty@mail.com', '17/4', 5, 80, 140708, 13220, '2020-01-08', 'Science Department', 'Teacher', 18000),
(1301, 'Sidonia', 'Byford', 'Female', '1999-04-24', '0942213455', 'Sidonia@mail.com', '16/4', 1, 1, 100101, 10200, '2021-05-16', 'Mathematics Department', 'Teacher', 16000),
(1302, 'Datha', 'Glowinski', 'Female', '1999-09-09', '0974869999', 'Datha@mail.com', '12/77', 11, 142, 200705, 20110, '2022-04-11', 'Mathematics Department', 'Teacher', 12000),
(1303, 'Jonas', 'Mattek', 'Male', '1987-05-26', '0947751346', 'Jonas@mail.com', '28/9', 1, 7, 100702, 10330, '2023-05-04', 'Mathematics Department', 'Teacher', 17000),
(1401, 'Adoree', 'Fendlow', 'Female', '1994-01-12', '0943758864', 'Adoree@mail.com', '123/44', 8, 110, 170203, 16130, '2022-05-24', 'Health and Physical Education Department', 'Teacher', 18000),
(1402, 'Tonia', 'Bendix', 'Female', '1989-07-08', '0876842034', 'Tonia@mail.com', '113/7', 1, 15, 101502, 10600, '2021-02-03', 'Health and Physical Education Department', 'Teacher', 20000),
(1403, 'Priscella', 'Balmforth', 'Female', '2000-04-27', '0812553444', 'Priscella@mail.com', '98', 1, 20, 102004, 10700, '2023-01-02', 'Health and Physical Education Department', 'Teacher', 17000),
(1501, 'Fowler', 'Potts', 'Male', '1994-07-04', '0879987546', 'Fowler@mail.com', '335', 1, 20, 102007, 10700, '2023-05-09', 'Arts Department', 'Teacher', 14000),
(1502, 'Jocko', 'Leupoldt', 'Male', '1993-03-26', '0945576845', 'Jocko@mail.com', '125', 1, 18, 101802, 10600, '2021-08-07', 'Arts Department', 'Teacher', 15000),
(1503, 'Justina', 'Pabst', 'Female', '1997-06-27', '0876779345', 'Justina@mail.com', '16/2', 1, 2, 100201, 10300, '2020-05-11', 'Arts Department', 'Teacher', 16000),
(1601, 'Olag', 'Gawthrop', 'Male', '1996-01-29', '0978432541', 'Olag@mail.com', '74', 1, 6, 100608, 10240, '2020-05-16', 'Social studies, Religion and Culture Department', 'Teacher', 16000),
(1602, 'Cointon', 'Chaytor', 'Male', '2000-11-27', '0933458761', 'Cointon@mail.com', '14/6', 3, 59, 120205, 11130, '2022-05-05', 'Social studies, Religion and Culture Department', 'Teacher', 17000),
(1603, 'Ward', 'Dawidsohn', 'Male', '1993-12-20', '0933415564', 'Ward@mail.com', '134', 1, 6, 100601, 10240, '2021-05-10', 'Social studies, Religion and Culture Department', 'Teacher', 19000),
(1701, 'Georas', 'Filon', 'Male', '1998-05-11', '0964435132', 'Georas@mail.com', '17/3', 1, 8, 100802, 10100, '2021-05-11', 'Career and Technology Department', 'Teacher', 18000),
(1702, 'Almire', 'Dreinan', 'Female', '1996-07-30', '0842436767', 'Almire@mail.com', '167/4', 1, 45, 104501, 10310, '2020-04-03', 'Career and Technology Department', 'Teacher', 20000),
(1703, 'Abeu', 'Aguirrezabala', 'Male', '1987-07-17', '0876421345', 'Abeu@mail.com', '24', 1, 4, 100404, 10500, '0000-00-00', 'Career and Technology Department', 'Teacher', 14000);
...
CREATE TABLE `teacher_classrooms` (
  `teacher_id` int(10) NOT NULL,
  `school_year` year(4) NOT NULL,
  `teacher_classroom` varchar(5) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `teacher_classrooms` (`teacher_id`, `school_year`, `teacher_classroom`) VALUES
(1001, 2021, '4/1'),
(1002, 2021, '4/1'),
(1003, 2021, '4/2'),
(1101, 2021, '4/2'),
...
INSERT INTO `teacher_subjects` (`subject_id`, `school_year`, `semester`, `teacher_id`) VALUES
('ART001', 2021, 1, 1501),
('ART001', 2021, 1, 1502),
('ART001', 2023, 1, 1501),
('ART002', 2023, 2, 1502),
...
('SCI101', 2021, 1, 1201),
('SCI101', 2021, 1, 1202),
('SCI10301', 2021, 1, 1302),
('SCI10301', 2021, 1, 1303),
('SOC001', 2021, 1, 1601),
('SOC001', 2021, 1, 1602),
('SOC001', 2022, 1, 1601),
('SOC001', 2022, 1, 1602),
...
ALTER TABLE `book_subjects`
  ADD PRIMARY KEY (`book_id`,`subject_id`,`school_year`,`semester`),
  ADD KEY `fk_book_subjects_subject` (`subject_id`,`school_year`,`semester`);
...
ALTER TABLE `classroom_subjects`
  ADD PRIMARY KEY (`classroom`,`school_year`,`semester`,`subject_id`),
  ADD KEY `fk_classroom_subjects_subject` (`subject_id`,`school_year`,`semester`);
...
--
-- Indexes for table `curriculum_prices`
--
ALTER TABLE `curriculum_prices`
  ADD PRIMARY KEY (`curriculum_id`,`school_year`);
...
ALTER TABLE `student_classrooms`
  ADD PRIMARY KEY (`student_id`,`school_year`),
  ADD KEY `fk_student_classrooms_classroom` (`student_classroom`);

--
-- Indexes for table `student_payments`
--
ALTER TABLE `student_payments`
  ADD PRIMARY KEY (`student_id`,`school_year`,`semester`);

--
-- Indexes for table `student_subjects`
--
ALTER TABLE `student_subjects`
  ADD PRIMARY KEY (`student_id`,`subject_id`,`school_year`,`semester`),
  ADD KEY `fk_student_subjects_subject` (`subject_id`,`school_year`,`semester`);

--
-- Indexes for table `subjects`
--
ALTER TABLE `subjects`
  ADD PRIMARY KEY (`subject_id`,`school_year`,`semester`);
...
ALTER TABLE `teacher_classrooms`
  ADD PRIMARY KEY (`teacher_id`,`school_year`),
  ADD KEY `teacher_classrooms_classroom` (`teacher_classroom`);

--
-- Indexes for table `teacher_subjects`
--
ALTER TABLE `teacher_subjects`
  ADD PRIMARY KEY (`subject_id`,`school_year`,`semester`,`teacher_id`),
...
--
ALTER TABLE `book_subjects`
  ADD CONSTRAINT `fk_book_subjects_book` FOREIGN KEY (`book_id`) REFERENCES `books` (`book_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_book_subjects_subject` FOREIGN KEY (`subject_id`,`school_year`,`semester`) REFERENCES `subjects` (`subject_id`, `school_year`, `semester`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `classroom_subjects`
--
ALTER TABLE `classroom_subjects`
  ADD CONSTRAINT `fk_classroom_subjects_classroom` FOREIGN KEY (`classroom`) REFERENCES `classrooms` (`classroom`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_classroom_subjects_subject` FOREIGN KEY (`subject_id`,`school_year`,`semester`) REFERENCES `subjects` (`subject_id`, `school_year`, `semester`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `curriculum_prices`
--
ALTER TABLE `curriculum_prices`
  ADD CONSTRAINT `curriculum_prices_curriculum` FOREIGN KEY (`curriculum_id`) REFERENCES `curriculums` (`curriculum_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `student_classrooms`
--
ALTER TABLE `student_classrooms`
  ADD CONSTRAINT `fk_student_classrooms_classroom` FOREIGN KEY (`student_classroom`) REFERENCES `classrooms` (`classroom`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_student_classrooms_student` FOREIGN KEY (`student_id`) REFERENCES `students` (`student_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `student_payments`
--
ALTER TABLE `student_payments`
  ADD CONSTRAINT `student_payments_student` FOREIGN KEY (`student_id`) REFERENCES `students` (`student_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `student_subjects`
  ...
  ADD CONSTRAINT `fk_student_subjects_subject` FOREIGN KEY (`subject_id`,`school_year`,`semester`) REFERENCES `subjects` (`subject_id`, `school_year`, `semester`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `teacher_classrooms`
--
ALTER TABLE `teacher_classrooms`
  ADD CONSTRAINT `teacher_classrooms_classroom` FOREIGN KEY (`teacher_classroom`) REFERENCES `classrooms` (`classroom`),
  ADD CONSTRAINT `teacher_classrooms_teacher` FOREIGN KEY (`teacher_id`) REFERENCES `teachers` (`teacher_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `teacher_subjects`
--
ALTER TABLE `teacher_subjects`
  ADD CONSTRAINT `fk_teacher_subjects_subject` FOREIGN KEY (`subject_id`,`school_year`,`semester`) REFERENCES `subjects` (`subject_id`, `school_year`, `semester`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_teacher_subjects_teacher` FOREIGN KEY (`teacher_id`) REFERENCES `teachers` (`teacher_id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
